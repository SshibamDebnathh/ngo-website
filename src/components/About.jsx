...
export default function About() {
  return (
    ...
    <div className="flex flex-wrap lg:flex-nowrap justify-center p-5 items-center bg-gray-300 w-full">
      <section id="about" className="p-8 lg:w-1/2 w-full justify-center items-center flex-row bg-gray-500 text-white m-3 rounded-lg border-black border-2 lg:h-[435px]">
    ...
    <section  className="p-5 bg-gray-300 lg:w-1/2 w-full m-3">
